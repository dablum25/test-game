...
class Spell:
  ...
  def draw(self, offset):
    ...
    if self.caster_grid:
      self.caster_animation.set_position(self.caster_x - 16 - offset_x - 32, self.caster_y - offset_y - 32)
      self.caster_animation.draw()
    
    if self.target_grid:
      self.target_animation.set_position(self.target_x - 16 - offset_x - 32, self.target_y - offset_y - 32)
