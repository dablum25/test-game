class Spell:
  ...
  def __init__(self, name, title, caster_source, target_source, range, level, target_hp, target_mp, target_hit, target_dam, target_arm, caster_hp, caster_mp, caster_hit, caster_dam, caster_arm, description):
